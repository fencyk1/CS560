...
public class ParserV2 implements ParserV2Interface{
	...
	public void parseSUBUCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
	...
	public void parseMULCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
	...
	public void parseMULUCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
	...
	public void parseDIVCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
		...
		else if (line.size() == 4)
		{
			...
			// if the reg3 is 0, give divide by zero error
			if (reg3.equals("$0"))
			{
			ErrorData error = new ErrorData();
			String code = errorsPossible.getErrorCode("divideByZero");
			String message = errorsPossible.getErrorMessage(code);
			error.add(lineNumber,Integer.parseInt(code), message);
			errorsFound.add(error);
			}
	...
	public void parseDIVUCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
	...
	public void parseNORCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
		...
		else if (line.size() == 4)
		{
			...
			// create the binary encoding
			String binEnc = converter.hexToBinary("02");
			binEnc = binEnc.concat("00");
			binEnc = binEnc + converter.decimalToBinary(reg1.substring(2));
			binEnc = binEnc + converter.decimalToBinary(reg2.substring(2));
			binEnc = binEnc + converter.decimalToBinary(reg3.substring(2));
	...
	public void parsePWRCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
	...
	public void parseSLLCommand(ArrayList<String> line, int lineNumber, ErrorOut errorsFound)
	{
